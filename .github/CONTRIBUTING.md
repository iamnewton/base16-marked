...
These files are automatically built with [Base16 Builder](https://github.com/chriskempson/base16-builder).
...
* Go to <https://github.com/iamnewton/base16-marked/pulls> and open a new pull request with your changes and fill out the template with the appropriate information.
